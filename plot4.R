...
par(mfrow = c(2,2))
plot(x = data$date_time, y = as.numeric(data$Global_active_power),xlab = '', ylab = 'Global Active Power', type = 'l')
plot(x = data$date_time, y = as.numeric(data$Voltage),xlab = '', ylab = 'Voltage', type = 'l' )
...
plot(x = data$date_time, y = as.numeric(data$Global_reactive_power),xlab = '', ylab = 'Global_Reactive_Power', type = 'l')
dev.off()
